...
project = u'Astara Release Notes'
...
from akanda.neutron.version import version_info as astara_version
...
htmlhelp_basename = 'AstaraNeutronReleaseNotesdoc'
...
man_pages = [
    ('index', 'AstaraNeutronreleasenotes',
     u'AstaraNeutron Release Notes Documentation',
